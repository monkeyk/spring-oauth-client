...
<hr/>
<p>
    获取access_token成功, 现在可以访问资源了, 以下提供两种方式去访问资源.
</p>
<ul>
    <li>
        方式1: 调用本地的接口,由后台去向服务器获取资源并进行处理(如将JSON数据转化成对象), 通过页面展示信息
        <br/>
        <a href="${contextPath}/unity_user_info?access_token=${accessTokenDto.accessToken}">Oauth Server 用户信息</a>
    </li>
    <li>
        方式2: 直接通过access_token去访问服务器的资源(该方式将直接获取JSON数据)
        <br/>
        <a href="${unityUserInfoUri}?access_token=${accessTokenDto.accessToken}" target="_blank">Oauth Server 用户信息
            [JSON]</a>
    </li>
    <li>...</li>
</ul>
<p class="help-block">
    至于使用哪一种方式更好, 请根据具体的需求或服务器资源的提供的访问方式去选择.
</p>
